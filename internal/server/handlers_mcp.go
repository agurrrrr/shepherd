...
export default function (pi: ExtensionAPI) {
  ...
  // --- Browser automation ---
  // ALL browser tools require sheep_name parameter. Always pass sheep_name with every browser tool call.
  const sheep = { sheep_name: Type.String({ description: "Sheep name (required for all browser tools)" }) };
  const browserTools = [
    { name: "browser_session_start", params: { ...sheep, headless: Type.Optional(Type.Boolean({ description: "Headless mode (default true)" })) } },
    { name: "browser_session_stop", params: { ...sheep } },
    { name: "browser_list_pages", params: { ...sheep } },
    { name: "browser_open", params: { ...sheep, url: Type.String({ description: "URL to open" }) } },
    { name: "browser_close", params: { ...sheep } },
    { name: "browser_navigate", params: { ...sheep, url: Type.String({ description: "URL to navigate to" }) } },
    { name: "browser_reload", params: { ...sheep } },
    { name: "browser_back", params: { ...sheep } },
    { name: "browser_forward", params: { ...sheep } },
    { name: "browser_click", params: { ...sheep, selector: Type.String({ description: "CSS selector" }) } },
    { name: "browser_type", params: { ...sheep, selector: Type.String({ description: "CSS selector" }), text: Type.String({ description: "Text to type" }) } },
    { name: "browser_select", params: { ...sheep, selector: Type.String({ description: "CSS selector" }), value: Type.String({ description: "Option value" }) } },
    { name: "browser_check", params: { ...sheep, selector: Type.String({ description: "CSS selector" }), checked: Type.Boolean({ description: "Checked state" }) } },
    { name: "browser_hover", params: { ...sheep, selector: Type.String({ description: "CSS selector" }) } },
    { name: "browser_scroll", params: { ...sheep, x: Type.Optional(Type.Number({ description: "Horizontal scroll amount" })), y: Type.Optional(Type.Number({ description: "Vertical scroll amount" })) } },
    { name: "browser_get_text", params: { ...sheep, selector: Type.String({ description: "CSS selector" }) } },
    { name: "browser_get_html", params: { ...sheep, selector: Type.Optional(Type.String({ description: "CSS selector (empty for full page)" })) } },
    { name: "browser_get_attribute", params: { ...sheep, selector: Type.String({ description: "CSS selector" }), attribute: Type.String({ description: "Attribute name" }) } },
    { name: "browser_get_url", params: { ...sheep } },
    { name: "browser_get_title", params: { ...sheep } },
    { name: "browser_eval", params: { ...sheep, js: Type.String({ description: "JavaScript code to execute" }) } },
    { name: "browser_wait_selector", params: { ...sheep, selector: Type.String({ description: "CSS selector" }), timeout: Type.Optional(Type.Number({ description: "Timeout in seconds (default 30)" })) } },
    { name: "browser_wait_hidden", params: { ...sheep, selector: Type.String({ description: "CSS selector" }), timeout: Type.Optional(Type.Number({ description: "Timeout in seconds (default 30)" })) } },
    { name: "browser_wait_load", params: { ...sheep } },
    { name: "browser_wait_idle", params: { ...sheep, timeout: Type.Optional(Type.Number({ description: "Timeout in seconds (default 30)" })) } },
    { name: "browser_screenshot", params: { ...sheep, selector: Type.Optional(Type.String({ description: "Element selector (empty for full page)" })), path: Type.Optional(Type.String({ description: "Save path (optional)" })) } },
    { name: "browser_pdf", params: { ...sheep, path: Type.Optional(Type.String({ description: "Save path (optional)" })) } },
    { name: "browser_console_start", params: { ...sheep } },
    { name: "browser_console_messages", params: { ...sheep, clear: Type.Optional(Type.Boolean({ description: "Delete messages after reading" })) } },
    { name: "browser_network_start", params: { ...sheep } },
    { name: "browser_network_requests", params: { ...sheep, clear: Type.Optional(Type.Boolean({ description: "Delete list after reading" })) } },
    { name: "browser_network_request", params: { ...sheep, request_id: Type.String({ description: "Request ID" }) } },
  ];
