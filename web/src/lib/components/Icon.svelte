<script>
	// Lucide-style stroke icons (24x24 viewBox, stroke-width 2, round caps).
	// Add new icons by appending an entry to ICONS.
	const ICONS = {
		...
		'list-checks': '<polyline points="3 17 5 19 9 15"/><polyline points="3 7 5 9 9 5"/><line x1="13" y1="6" x2="21" y2="6"/><line x1="13" y1="12" x2="21" y2="12"/><line x1="13" y1="18" x2="21" y2="18"/>',
