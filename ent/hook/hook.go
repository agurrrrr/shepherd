...
// The SheepFunc type is an adapter to allow the use of ordinary
// function as Sheep mutator.
type SheepFunc func(context.Context, *ent.SheepMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f SheepFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SheepMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.SheepMutation", m)
}

// The SheepNameFunc type is an adapter to allow the use of ordinary
// function as SheepName mutator.
type SheepNameFunc func(context.Context, *ent.SheepNameMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f SheepNameFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.SheepNameMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.SheepNameMutation", m)
}
