...
| 2 | **출력 데이터 무제한 누적으로 인한 메모리 폭발** | ❌ 미해결 | 본 문서의 개선 대상 |
...
| 우선순위 | 방향 | 위험도 | 효과 | 권장 |
|---------|------|--------|------|------|
| 1순위 | **B: RunningTask.OutputLines 제한** | 매우 낮음 | 높음 | ✅ 즉시 적용 |
| 2순위 | **A: outputBuilder 제한** | 낮음 | 높음 | ✅ 즉시 적용 |
| 3순위 | **C: processor.go outputLines 제한** | 중간 | 중간 | ✅ 적용 권장 |
